...
var toCSV = function toCSV(state) {
  var datas = state.dataSource.dataset;
  var maxNum = 0;
  var maxIndex = -1;
  var arr = [];
  var rootObj = {};
  ...
  var csv = "data:text/csv;charset=utf-8," + ConvertToCSV(arr);
...
function (_React$Component) {
  ...
  function _default(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "download", function () {
      toCSV(_this.state);
    });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(_default, [{
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        return __jsx("div", null, __jsx(_Row__WEBPACK_IMPORTED_MODULE_16__["default"], {
          key: i,
        ...
        }, _this3.state.averages && _this3.state.averages[i] ? "~".concat(_this3.state.averages[i], "ms") : "-"), __jsx("button", {
...
//# sourceMappingURL=1.bb577f19cd2d2d539529.hot-update.js.map